...
<body>
	...
	<main style="width: auto; height: auto;">
		...
		<div
			style="display: flex; width: 1750px; height: 800px	; margin: 20px; margin-left: 130px; justify-content: space-between">
			<div
				...
				<h2
					...
					<hr style="background-color: #cc6600; height: 1.5px">
					 ...
					 <div class="alert alert" role="alert" style="margin-top: 70px">
            <h4 class="alert-heading" style="font-size: 30px">Thanh toán thành công!</h4>
            <p style="font-size: 20px">Cảm ơn bạn đã mua hàng tại cửa hàng của chúng tôi. Đơn hàng của bạn đã được xử lý thành công.</p>
            <hr>
            <p class="mb-0" style="font-size: 20px">Bạn có thể <a href="index.jsp">quay lại trang chính</a> và vui lòng đợi khoảng một chút thời gian chúng tôi sẽ gửi gamil chi tiết đơn hàng về cho bạn.</p>
        </div>
