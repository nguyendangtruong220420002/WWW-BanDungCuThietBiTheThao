...
<body>
	<header>
		...
		<div style="text-align: center; margin-top: 10px">
			<h2 style="font-weight: bold;">Danh Sách Loại Sản Phẩm</h2>
		</div>
	</header>
	<nav class="sidebar">
		<ul class="nav-list">
	...
	<main>
        ...
        <a href="LoaiSanPhamServlet" class="btn btn-primary mb-2">Thêm Loại Sản Phẩm</a>
        <table class="table">
            ...
            <tbody>
                <c:forEach var="loaiSanPham" items="${loaiSanPhamList}">
                    <tr>
                        ...
                        <td>
                            <form action="LoaiSanPhamServlet" method="post" style="display:inline;">
                                <input type="hidden" name="action" value="delete">
                                <input type="hidden" name="maloai" value="${loaiSanPham.maloaisp}">
