...
.show {
   ...
   .product-list {
        max-height: 20px; /* Chiều cao tối đa của danh sách sản phẩm */
			...
			<div class="content">
				<div class="row mb"
					...
					<div class="col-md"
						...
						<p>Tổng số tiền bán được:<fmt:formatNumber value=" ${totalSales}" type="currency" currencySymbol="₫" /></p>
    ...
    <div class="product-container">
        <ul class="product-list">
            <c:forEach var="sanPham" items="${payment.sanPhams}">
                <li> ${sanPham.tensanpham}, Số lượng: ${sanPham.soluong}, Giá: <fmt:formatNumber value="${sanPham.giagiam}" type="currency" currencySymbol="₫" /></li>
            </c:forEach>
        </ul>
