...
.product-list {
	...
	/* Hiệu ứng chuyển tiếp khi mở rộng */
}
	...
	<header>
		<div class="logo">
			...
			<div class="logo-right">
				<li>
					<form action="DanhSachUserServlet" method="get">
						<input type="text" name="query" placeholder="Tìm kiếm theo email...">
			...
			<div class="content">
				<div class="row mb"
					...
					<div class="col-md-4"
						...
						<p>Tổng số tài khoảng User: ${fn:length(users)}</p>
					</div>
						...
						<td>
							...
							<form action="DanhSachUserServlet" method="post"
								...
								<input type="hidden" name="action" value="edit" /> <input
									type="hidden" name="maUser" value="${user.mauser}" /> <input
									type="submit" value="edit" class="btn btn-warning" />
							</form> <!-- Delete Form -->
							<form action="DanhSachUserServlet" method="post"
								style="display: inline;">
								<input type="hidden" name="action" value="delete" /> <input
									type="hidden" name="maUser" value="${user.mauser}" /> <input
									type="submit" value="Xóa" class="btn btn-dark"/>
							</form>
						</td>
					</tr>
				</c:forEach>
