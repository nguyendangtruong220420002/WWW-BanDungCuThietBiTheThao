...
<body>
			...
			<nav>
				<ul>
					<div class="ul">
						...
						<div class="ul-right">
							<li>
					<form action="TimKiemProductsServlet" method="get">
	...
	<main style="background-color: #f0f5f5">
		<div class="conter">
			<div class="content">
				<div class="row mb"
					style="display: flex; align-items: center; margin-left: 20px; margin-top: 20px">
					<div class="col-md-4" style="display: flex; align-items: center;  ">
						 <select id="filterByCategory" class="form-control" style=" font-size: 20px;" >
							<option value="" style="font-weight: bold; font-size: 20px;">ALL</option>
							<c:forEach items="${loc}" var="locloai">
								<option style="font-weight: bold; font-size: 20px;" value="${locloai}">${locloai}</option>
							</c:forEach>
						</select>
					</div>
				</div>
				<div class="custom-row row">
					<c:forEach var="sanPham" items="${sanPhamList}">
						<div class="product-item" data-category="${sanPham.tenloaisp}">
							<form action="CartServlet" method="post"name="modelDetail">
							<div class="card h-105">
								<img class="img-thumbnail" src="IMG/IMG_SanPham/${sanPham.img}" name="anh" id="anh"
									alt="${sanPham.img}">
								<a href="ChiTietSanPhamServlet?masanpham=${sanPham.masanpham}" style="color: black;text-decoration: none;">
									<h5 style="margin: 10px; font-size: 20px;font-weight: bold;"name="ten" id="ten">${sanPham.tensanpham}</h5>
									<div style="display: flex; align-items: center; padding-left: 40px;">
									 <div class="card-text">
                        			<p ><fmt:formatNumber value="${sanPham.gia}" type="currency" currencySymbol="₫" /></p>
                   					 </div>
                   					  <div class="card-text-giam">
                        			<p name="giatien" ><fmt:formatNumber value="${sanPham.giagiam}" type="currency" currencySymbol="₫" /></p>      
                   					 </div>
									</div>
                    				</a>
            					...
            					<input type="hidden" name="giatien" value="${sanPham.giagiam}">	
										<div style="display: flex; padding-left: 35px;">
											<div style="display: flex; flex-direction: column; align-items: center;" >
												<label style="font-size: 15px; color: #808080;">Số lượng</label> <input type="text" size="2"
												style="border: 2px; width: 30px; text-align: center; font-size: 15px;" 	value="1" name="soluongmua" id="soluongmua">
											</div>
											<div style="display: flex; margin-left: 20px">
											<input type="hidden" name="action" value="add"> 
												<input type="submit" value="Thêm vào giỏ hàng"
													class="btn btn-warning" style="font-size: 20px; font-weight: bold; color: #4d4d4d;">
											</div>
										</div>
									</form>
								</div>
