 ...
 * Generated at: 2024-07-28 05:51:15 UTC
...
public final class DSDonHang_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        max-height: 20px; /* Chiều cao tối đa của danh sách sản phẩm */\r\n");
      out.write("        overflow: hidden; /* Ẩn nội dung vượt quá chiều cao tối đa */\r\n");
      out.write("        transition: max-height 0.3s ease; /* Hiệu ứng chuyển tiếp khi mở rộng */\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    .product-list.show-more {\r\n");
      out.write("        max-height: 100%; /* Chiều cao tối đa khi mở rộng */\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    .show-more-btn {\r\n");
      out.write("        cursor: pointer; /* Con trỏ chuột khi di chuột qua nút */\r\n");
      out.write("        color: #007bff; /* Màu chữ của nút \"Xem thêm\" */\r\n");
      out.write("       \r\n");
      out.write("    }\r\n");
      out.write("</style>\r\n");
      out.write("<script>\r\n");
      ...
      out.write("	    // Lấy ngày từ form lọc\r\n");
      out.write("	    const filterDate = document.getElementById('filterDate').value;\r\n");
      out.write("	    const formattedDate = new Date(filterDate).toISOString().split('T')[0]; // Định dạng ngày theo yyyy-MM-dd\r\n");
      out.write("\r\n");
      out.write("	    // Lấy tất cả các hàng trong bảng\r\n");
      out.write("	    const rows = document.querySelectorAll('#paymentsTableBody tr');\r\n");
      out.write("\r\n");
      out.write("	    rows.forEach(row => {\r\n");
      out.write("	        // Lấy giá trị ngày từ thuộc tính data-date\r\n");
      out.write("	        const rowDate = row.getAttribute('data-date');\r\n");
      out.write("	        \r\n");
      out.write("	        // So sánh ngày để quyết định hiển thị hoặc ẩn hàng\r\n");
      out.write("	        if (rowDate === formattedDate) {\r\n");
      out.write("	            row.style.display = ''; // Hiển thị hàng\r\n");
      out.write("	        } else {\r\n");
      out.write("	            row.style.display = 'none'; // Ẩn hàng\r\n");
      out.write("	        }\r\n");
      out.write("	    });\r\n");
      out.write("	}\r\n");
      out.write("	function toggleDescription(element) {\r\n");
      out.write("        var productList = element.previousElementSibling;\r\n");
      out.write("        if (productList.classList.contains('show-more')) {\r\n");
      out.write("            productList.classList.remove('show-more');\r\n");
      out.write("            element.textContent = 'Xem thêm';\r\n");
      out.write("        } else {\r\n");
      out.write("            productList.classList.add('show-more');\r\n");
      out.write("            element.textContent = 'Thu gọn';\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("	\r\n");
      out.write("</script>\r\n");
      ...
      out.write("			<h2 style=\"font-weight: bold;\">Danh Sách Đơn Hàng</h2>\r\n");
      out.write("		</div>\r\n");
      out.write("	</header>\r\n");
      ...
      out.write("			<li><a href=\"DSDonHangServlet\"><img alt=\"\"\r\n");
      out.write("					src=\"IMG/sale.png\" class=\"menu-icons\">ĐƠN HÀNG</a></li>\r\n");
      out.write("		</ul>\r\n");
      out.write("	</nav>\r\n");
      out.write("	<main>\r\n");
      out.write("		<div class=\"container\"\r\n");
      out.write("			style=\"background-color: #f2f2f2; max-width: 1600px\">\r\n");
      out.write("\r\n");
      out.write("			<div class=\"content\">\r\n");
      out.write("				<div class=\"row mb\"\r\n");
      out.write("					style=\"display: flex; align-items: center; margin-left: 20px;\">\r\n");
      out.write("\r\n");
      out.write("					<div class=\"col-md-4\" style=\"display: flex; align-items: center;\">\r\n");
      out.write("						<form id=\"filterForm\" method=\"get\">\r\n");
      out.write("							<label for=\"filterDate\">Chọn ngày:</label> <input type=\"date\"\r\n");
      out.write("								id=\"filterDate\" name=\"filterDate\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${filterDate}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\" />\r\n");
      out.write("							<button type=\"submit\">Lọc</button>\r\n");
      out.write("						</form>\r\n");
      out.write("					</div>\r\n");
      out.write("					\r\n");
      out.write("					<div class=\"col-md-4\"\r\n");
      out.write("						style=\"font-weight: bold; font-size: 20px; margin-left: 100px\">\r\n");
      out.write("\r\n");
      out.write("						<p>Tổng số đơn hàng: ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:length(payments)}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, _jspx_fnmap_0));
      out.write("</p>\r\n");
      out.write("					</div>\r\n");
      out.write("					<div class=\"col-md\"\r\n");
      out.write("						style=\"font-weight: bold; font-size: 20px; margin-right: 50px\">\r\n");
      out.write("\r\n");
      out.write("						<p>Tổng số tiền bán được:");
      ...
      out.write("\r\n");
      out.write("				</thead>\r\n");
      out.write("				<tbody id=\"paymentsTableBody\">\r\n");
      out.write("					");
 ...
 if (session.getAttribute("loginFailed") != null && (Boolean) session.getAttribute("loginFailed")) { 
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /QuanLy/DSDonHang.jsp(270,7) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fwhen_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /QuanLy/DSDonHang.jsp(271,61) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /QuanLy/DSDonHang.jsp(335,31) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /QuanLy/DSDonHang.jsp(335,31) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatNumber_005f0.setType("currency");
      // /QuanLy/DSDonHang.jsp(335,31) name = currencySymbol type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /QuanLy/DSDonHang.jsp(357,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("payment");
      // /QuanLy/DSDonHang.jsp(357,5) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/QuanLy/DSDonHang.jsp(357,5) '${payments}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${payments}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("						<tr>\r\n");
            out.write("							<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payment.hoten}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("							<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payment.email}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("							<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payment.address}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("							<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payment.phone}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("							<td>");
            ...
            out.write("</td>\r\n");
            out.write("							<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payment.ghichu}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("							<td>\r\n");
            ...
            out.write("\r\n");
            out.write("        </ul>\r\n");
            out.write("        <span class=\"show-more-btn\" onclick=\"toggleDescription(this)\" style=\"color:  #bfbfbf;\">Xem thêm</span>\r\n");
            out.write("    </div>\r\n");
            out.write("</td>\r\n");
            out.write("						</tr>\r\n");
            out.write("					");
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /QuanLy/DSDonHang.jsp(364,11) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatNumber_005f1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payment.total}", java.lang.Object.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      // /QuanLy/DSDonHang.jsp(364,11) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatNumber_005f1.setType("currency");
      // /QuanLy/DSDonHang.jsp(364,11) name = currencySymbol type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /QuanLy/DSDonHang.jsp(365,11) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatDate_005f0.setValue((java.util.Date) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payment.purchaseDate}", java.util.Date.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      // /QuanLy/DSDonHang.jsp(365,11) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /QuanLy/DSDonHang.jsp(371,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("sanPham");
      // /QuanLy/DSDonHang.jsp(371,12) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/QuanLy/DSDonHang.jsp(371,12) '${payment.sanPhams}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${payment.sanPhams}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f2(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /QuanLy/DSDonHang.jsp(372,79) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatNumber_005f2.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sanPham.giagiam}", java.lang.Object.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      // /QuanLy/DSDonHang.jsp(372,79) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatNumber_005f2.setType("currency");
      // /QuanLy/DSDonHang.jsp(372,79) name = currencySymbol type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
