...
<head>
<meta charset="UTF-8">
<title>Form Loại Sản Phẩm</title>
...
<body>
	<header>
		...
		<div style="text-align: center; margin-top: 10px">
			<h2 style="font-weight: bold; margin-top: 20px">Danh Sách Loại Sản Phẩm</h2>
		</div>
	</header>
	<nav class="sidebar">
		<ul class="nav-list">
		...
		<div class="container mt-4">
			<div class="row">
				<div class="col-md-6 offset-md-3">
					<div class="card">
						<div class="card-header bg-primary text-white">Thêm mới Loại
							Sản Phẩm</div>
						<div class="card-body">
							<form action="LoaiSanPhamServlet" method="post">
								<input type="hidden" name="action" value="add">
								<div class="form-group">
									<label for="maloai">Mã Loại:</label> <input type="text"
										class="form-control" id="maloai" name="maloai" value="">

									<%
   										String maloaiError = (String) request.getAttribute("maloaiError");
    									if (maloaiError != null && !maloaiError.isEmpty()) {
									%>
									<span style="color: red;"><%= maloaiError %></span>
									<%
    									}
									%>
								</div>
								<div class="form-group">
									<label for="tenloai">Tên Loại:</label> <input type="text"
										class="form-control" id="tenloai" name="tenloai" value="">
								</div>
								<div class="form-group">
									<label for="ghichu">Ghi Chú:</label> <input type="text"
										class="form-control" id="ghichu" name="ghichu" value="">
								</div>
								<button type="submit" class="btn btn-primary">Thêm Mới</button>
								<a href="DanhSachLoaiSanPhamServlet" class="btn btn-secondary">Hủy</a>
							</form>
						</div>
					</div>
				</div>
